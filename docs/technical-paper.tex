...
\caption{TapTapp AR in action: Real-time image tracking with detected feature points (green dots) and 3D content overlay. HD 1280×960 resolution enables precise tracking.}
\label{fig:ar_demo}
\end{figure}
...
\caption{Framework Comparison: TapTapp AR vs MindAR. TapTapp achieves 24× faster compilation ($\sim$1s vs 24s) and 200× smaller bundle (0.1MB vs 20MB).}
\label{fig:perfchart}
\end{figure}
